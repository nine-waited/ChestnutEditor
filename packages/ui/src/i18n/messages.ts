...
const en: MessageTable = {
  ...
  "settings.pluginsHint":
    "Import a Chestnut plugin zip into this app's plugins folder (next to the editor executable), not your notes folder. Select one to load; click it again to unload it from memory.",
  ...
  "note.editorContextMenuTableDeleteRow": "Delete row",
  "note.editorContextMenuTableDeleteCol": "Delete column",
  "note.editorContextMenuTableDelete": "Delete table",
  "note.editorContextMenuTableAlignLeft": "Align left",
  "note.editorContextMenuTableAlignCenter": "Align center",
  "note.editorContextMenuTableAlignRight": "Align right",
  ...
  "note.pinImageAction": "Pin to desktop",
...
const zhCN: MessageTable = {
  ...
  "settings.plugins": "插件",
  "settings.pluginsHint": "将板栗猫娘 zip 包导入到编辑器安装目录的 plugins 文件夹，而不是笔记库目录。点选加载，再点一次卸载并释放内存。",
  ...
  "note.editorContextMenuTableRowAbove": "在上方插入行",
  "note.editorContextMenuTableRowBelow": "在下方插入行",
  "note.editorContextMenuTableColLeft": "在左侧插入列",
  "note.editorContextMenuTableColRight": "在右侧插入列",
  "note.editorContextMenuTableDeleteRow": "删除行",
  "note.editorContextMenuTableDeleteCol": "删除列",
  "note.editorContextMenuTableDelete": "删除表格",
  "note.editorContextMenuTableAlignLeft": "左对齐",
  "note.editorContextMenuTableAlignCenter": "居中对齐",
  "note.editorContextMenuTableAlignRight": "右对齐",
