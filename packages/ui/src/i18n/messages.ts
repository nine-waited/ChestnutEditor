...
const en: MessageTable = {
  ...
  "toolbar.checkUpdateTooltip": "Check for updates",
  "toolbar.checkUpdateChecking": "Checking for updates…",
  "toolbar.startupDebugTooltip": "Startup debug log",
  ...
  "status.fileCut": "File cut.",
  "status.copyFailed": "Failed to copy to clipboard.",
  "status.copyFileDesktopOnly": "Copying files requires the desktop app.",
  "status.cutFailed": "Failed to cut.",
  "status.cutFileDesktopOnly": "Cutting files requires the desktop app.",
  "status.cutNotAllowed": "These items cannot be cut.",
  ...
  "status.importMarkdownSuccessMultiple": "Imported {count} Markdown notes.",
  "status.importMarkdownDropOnlyMd": "Only Markdown (.md) files can be dropped into Chestnut.",
  "status.importMarkdownDropNeedsVault": "Open a vault before importing Markdown.",
  "status.alwaysOnTopFailed": "Failed to change always-on-top.",
  "status.pinImageFailed": "Failed to pin image to desktop.",
  "status.updateChecking": "Checking GitHub for updates…",
  "status.updateNone": "No GitHub release found.",
  "status.updateCurrent": "Already up to date: {channel} {version}.",
  "status.updateFailed": "Failed to check for updates.",
  "status.updateOpened": "Opened download page for {version}.",
  "status.updateAvailable": "Update available: {channel} {version}.",
  "update.channelRelease": "release",
  "update.channelPrerelease": "pre-release",
  "update.availableTitle": "Update available",
  "update.availableMessage":
    "Current version is {current}. Latest {channel} is {version}. Open the download page?",
  "update.openDownload": "Open download page",
  "update.checkTitle": "Check for updates",
  "update.checkCurrent": "Current version {version}",
  "update.phaseConnect": "Connecting to GitHub",
  "update.phaseFetch": "Fetching release list",
  "update.phaseCompare": "Comparing versions",
  "update.close": "Close",
  "update.resultNone": "No published GitHub release was found.",
  "update.resultCurrent": "Already up to date: {channel} {version}.",
  "update.resultAvailable":
    "Current version is {current}. Latest {channel} is {version}.",
  "update.resultFailed": "Could not reach GitHub. Check the network and try again.",
  "update.resultTitleCurrent": "Up to date",
  "update.resultTitleNone": "No release found",
  "update.resultTitleFailed": "Update check failed",
  "update.phaseDone": "Done · 100%",
  "update.phaseFailed": "Failed",
  ...
  "settings.font": "Font",
  "settings.fontHint":
    "Microsoft YaHei is always available. Xiaolai (~21 MB) and Yozai (~15 MB) can be downloaded when you want them, then uninstalled. OFL license.",
  "settings.fontMicrosoftYaHei": "Microsoft YaHei",
  "settings.fontYozai": "Yozai (handwriting)",
  "settings.fontXiaolai": "Xiaolai (handwriting)",
  "settings.fontSystemHint": "Available on this computer",
  "settings.fontInstalled": "Downloaded. Click to use, or uninstall to remove.",
  "settings.fontNotInstalled": "Not downloaded yet",
  "settings.fontDownload": "Download",
  "settings.fontDownloading": "Downloading…",
  "settings.fontDownloadFailed": "Download failed: {error}",
  "settings.fontUninstall": "Uninstall",
  "settings.fontUninstallTitle": "Uninstall font",
  "settings.fontUninstallMessage":
    "Remove {name} from this computer? The interface will switch back to Microsoft YaHei. You can download it again later.",
  ...
  "settings.pluginsHint":
    "Chestnut Cat is optional (~18 MB) and is not bundled. Download it when you want it. Select to load; click again to unload. Uninstall removes it from disk.",
  "settings.pluginChestnutCat": "Chestnut Cat",
  "settings.pluginChestnutCatHint": "A corner pet that shows today's Markdown writing stats.",
  "settings.pluginsNotInstalled": "Not downloaded yet",
  "settings.pluginsInstalled": "Downloaded. Click to use, or uninstall to remove.",
  "settings.pluginsDownload": "Download",
  "settings.pluginsDownloading": "Downloading…",
  "settings.pluginsDownloadFailed": "Download failed: {error}",
  "settings.pluginsUninstall": "Uninstall",
  "settings.pluginsUninstallTitle": "Uninstall plugin",
  "settings.pluginsUninstallMessage": "Remove {name} from this computer? You can download it again later.",
  ...
  "note.refreshAria": "Reload the current document from disk",
  ...
  "note.editorContextMenuTableDeleteRow": "Delete current row",
  "note.editorContextMenuTableDeleteCol": "Delete current column",
  "note.editorContextMenuTableColLeft": "Insert column left",
  "note.editorContextMenuTableColRight": "Insert column right",
  "note.editorContextMenuTableRowAbove": "Insert row above",
  "note.editorContextMenuTableRowBelow": "Insert row below",
  ...
  "note.copyImageAction": "Copy image",
  "note.zoomImageAction": "Zoom image",
  "note.pinImageAction": "Floating pin",
  "note.imageCaptionPlaceholder": "Add description…",
  "note.codeBlockCopy": "Copy",
  "note.codeBlockCopied": "Copied",
  "note.insertLeadingLine": "Insert line above",
  ...
  "commands.toggleSource": "Toggle source / live",
  ...
  "shortcuts.md-toggle-source": "Toggle source / live",
  "settings.editorShortcuts": "Markdown editor shortcuts",
  "settings.editorShortcutsHint": "Shortcuts below apply while editing notes. Use formats like Ctrl+B or Ctrl+Wheel. Heading navigation, zoom, and source/live toggle cannot be customized.",
...
const zhCN: MessageTable = {
  ...
  "toolbar.checkUpdateTooltip": "检查更新",
  "toolbar.checkUpdateChecking": "正在检查更新…",
  "toolbar.startupDebugTooltip": "启动调试日志",
  ...
  "status.cutFailed": "剪切失败。",
  "status.cutFileDesktopOnly": "剪切文件需要使用桌面版。",
  "status.cutNotAllowed": "这些项目不能剪切。",
  ...
  "status.importMarkdownSuccessMultiple": "已导入 {count} 篇 Markdown 笔记。",
  "status.importMarkdownDropOnlyMd": "只能拖入 Markdown（.md）文件。",
  "status.importMarkdownDropNeedsVault": "请先打开知识库再导入 Markdown。",
  "status.alwaysOnTopFailed": "切换窗口置顶失败。",
  "status.updateChecking": "正在向 GitHub 检查更新…",
  "status.updateNone": "未找到 GitHub 发布。",
  "status.updateCurrent": "已是最新：{channel} {version}。",
  "status.updateFailed": "检查更新失败。",
  "status.updateOpened": "已打开 {version} 的下载页面。",
  "status.updateAvailable": "发现新版本：{channel} {version}。",
  "update.channelRelease": "正式版",
  "update.channelPrerelease": "预发布",
  "update.availableTitle": "发现新版本",
  "update.availableMessage": "当前版本 {current}。最新{channel}为 {version}。是否打开下载页？",
  "update.openDownload": "打开下载页",
  "update.checkTitle": "检查更新",
  "update.checkCurrent": "当前版本 {version}",
  "update.phaseConnect": "正在连接 GitHub",
  "update.phaseFetch": "正在获取 Release 列表",
  "update.phaseCompare": "正在对比版本",
  "update.close": "关闭",
  "update.resultNone": "未找到已发布的 GitHub Release。",
  "update.resultCurrent": "已是最新{channel}：{version}。",
  "update.resultAvailable": "当前版本 {current}。最新{channel}为 {version}。",
  "update.resultFailed": "无法连接 GitHub，请检查网络后重试。",
  "update.resultTitleCurrent": "已是最新",
  "update.resultTitleNone": "未找到发布",
  "update.resultTitleFailed": "检查更新失败",
  "update.phaseDone": "完成 · 100%",
  "update.phaseFailed": "失败",
  ...
  "settings.font": "字体",
  "settings.fontHint":
    "默认使用微软雅黑。小赖（约 21 MB）和悠哉（约 15 MB）可按需下载后使用，也可随时卸载。字体为 OFL 开源许可。",
  "settings.fontMicrosoftYaHei": "微软雅黑",
  "settings.fontYozai": "悠哉体（手写）",
  "settings.fontXiaolai": "小赖体（手写）",
  "settings.fontSystemHint": "本机系统字体，始终可用",
  "settings.fontInstalled": "已下载。点击即可使用，也可卸载。",
  "settings.fontNotInstalled": "尚未下载",
  "settings.fontDownload": "下载",
  "settings.fontDownloading": "下载中…",
  "settings.fontDownloadFailed": "下载失败：{error}",
  "settings.fontUninstall": "卸载",
  "settings.fontUninstallTitle": "卸载字体",
  "settings.fontUninstallMessage":
    "要从本机删除「{name}」吗？界面会改回微软雅黑，之后可以再下载。",
  ...
  "settings.plugins": "插件",
  "settings.pluginsHint":
    "桌宠 Chestnut Cat 可按需下载（约 18 MB），不打进安装包。点选加载，再点一次从内存卸载。卸载会删除本机插件文件。",
  "settings.pluginChestnutCat": "Chestnut Cat",
  "settings.pluginChestnutCatHint": "角落桌宠，展示当天 Markdown 写作统计。",
  "settings.pluginsNotInstalled": "尚未下载",
  "settings.pluginsInstalled": "已下载。点击即可使用，也可卸载。",
  "settings.pluginsDownload": "下载",
  "settings.pluginsDownloading": "下载中…",
  "settings.pluginsDownloadFailed": "下载失败：{error}",
  "settings.pluginsUninstall": "卸载",
  "settings.pluginsUninstallTitle": "卸载插件",
  "settings.pluginsUninstallMessage": "要从本机删除「{name}」吗？之后可以再下载。",
  ...
  "note.editorContextMenuTableDeleteRow": "删除当前行",
  "note.editorContextMenuTableDeleteCol": "删除当前列",
  "note.editorContextMenuTableColLeft": "向左新增一列",
  "note.editorContextMenuTableColRight": "向右新增一列",
  "note.editorContextMenuTableRowAbove": "向上新增一行",
  "note.editorContextMenuTableRowBelow": "向下新增一行",
  ...
  "note.copyImageAction": "复制图片",
  "note.zoomImageAction": "放大预览",
  "note.pinImageAction": "图钉悬浮",
  "note.imageCaptionPlaceholder": "添加描述…",
  "note.codeBlockCopy": "复制",
  "note.codeBlockCopied": "已复制",
  "note.insertLeadingLine": "在上方插入空行",
  "fileTree.rename": "重命名",
  "fileTree.delete": "删除",
  ...
  "shortcuts.md-toggle-source": "切换源码与渲染",
  "settings.editorShortcuts": "Markdown 编辑器快捷键",
  "settings.editorShortcutsHint": "以下快捷键在编辑笔记时生效。可使用 Ctrl+B、Ctrl+Wheel 等格式。标题跳转、编辑器缩放与源码/渲染切换不可修改。",
