...
const en: MessageTable = {
  ...
  "settings.markdownSaveMode": "Markdown save mode",
  "settings.markdownSaveModeHint":
    "Default is autosave every 15 seconds plus Ctrl+S / ⌘S. Realtime save writes to disk immediately on each edit.",
...
const zhCN: MessageTable = {
  ...
  "settings.notes": "笔记",
  "settings.markdownSaveMode": "Markdown 保存方式",
  "settings.markdownSaveModeHint":
    "默认为每 15 秒自动保存，也可按 Ctrl+S / ⌘S 手动保存。实时保存会在每次编辑后立刻写入磁盘。",
