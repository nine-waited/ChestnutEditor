...
const en: MessageTable = {
  ...
  "toolbar.feedbackTooltip": "Report an issue",
  "toolbar.checkUpdateTooltip": "Check for updates",
  "toolbar.checkUpdateChecking": "Checking for updates…",
  "toolbar.checkUpdateShowProgress": "View update progress",
  "toolbar.checkUpdateShowStatus": "View update status",
  "toolbar.checkUpdateRetry": "Retry update",
  "toolbar.startupDebugTooltip": "Startup debug log",
  "toolbar.importMarkdownTooltip": "Import Markdown or ZIP",
  ...
  "status.importMarkdownDropOnlyMd": "Only Markdown (.md) files or exported ZIP archives can be dropped into Chestnut.",
  "status.importZipFailed": "Failed to import ZIP archive.",
  ...
  "status.feedbackOpened": "Opened GitHub issues in the browser.",
  "status.feedbackFailed": "Failed to open the feedback page.",
  "status.updateChecking": "Checking for updates…",
  "status.updateNone": "No release found.",
  ...
  "status.updateReleasePageOpened": "Opened the release page in your browser.",
  "status.updateAvailable": "Update available: {channel} {version}.",
  "status.updateDownloading": "Downloading {version}…",
  "status.updateInstallerOpened": "Opened installer for {version}.",
  "status.updateDownloadFailed": "Failed to download the installer.",
  ...
  "update.availableMessage":
    "Current version is {current}. Latest {channel} is {version}. Download and install now?",
  "update.confirm": "Update",
  "update.openDownload": "Open download page",
  "update.openGitCode": "Open GitCode",
  "update.openGitHub": "Open GitHub",
  "update.checkTitle": "Check for updates",
  "update.checkCurrent": "Current version {version}",
  "update.phaseConnect": "Connecting to release service",
  "update.phaseFetch": "Fetching release list",
  "update.phaseCompare": "Comparing versions",
  "update.phaseDownload": "Downloading installer",
  "update.phaseOpen": "Opening installer",
  "update.close": "Close",
  "update.hide": "Hide",
  "update.retry": "Retry",
  "update.backgroundHint": "Press Esc to hide. The update continues in the background.",
  "update.resultNone": "No published release was found.",
  "update.resultCurrent": "Already up to date: {channel} {version}.",
  "update.resultAvailable":
    "Current version is {current}. Latest {channel} is {version}. Confirm to download the installer.",
  "update.resultFailed": "Could not reach the release service. Retry or open GitCode / GitHub in your browser.",
  "update.resultNoInstaller": "This release has no Windows installer. Open the GitHub page instead.",
  "update.resultDownloading": "Downloading {file}…",
  "update.resultOpenedInstaller": "The installer has been opened. Follow the wizard to finish updating.",
  "update.resultDownloadFailed": "Failed to download the installer. Check the network and try again.",
  "update.resultTitleCurrent": "Up to date",
  "update.resultTitleNone": "No release found",
  "update.resultTitleFailed": "Update check failed",
  "update.resultTitleDownloading": "Downloading update",
  "update.resultTitleOpened": "Installer opened",
  "update.resultTitleDownloadFailed": "Download failed",
  ...
  "importFiles.title": "Importing",
  "importFiles.phasePrepare": "Reading files",
  "importFiles.phaseRender": "Extracting archive",
  "importFiles.phaseImages": "Copying images",
  "importFiles.phaseGenerate": "Importing notes",
  "importFiles.phaseSave": "Saving notes",
  "importFiles.phaseDone": "Done",
  ...
  "note.updatedAt": "Last updated: {time}",
  "note.times": "Document time",
  "note.timesAria": "Show or hide created and last-updated time",
  ...
  "fileTree.importMarkdown": "Import documents",
...
const zhCN: MessageTable = {
  ...
  "toolbar.feedbackTooltip": "问题反馈",
  "toolbar.checkUpdateTooltip": "检查更新",
  "toolbar.checkUpdateChecking": "正在检查更新…",
  "toolbar.checkUpdateShowProgress": "查看更新进度",
  "toolbar.checkUpdateShowStatus": "查看更新状态",
  "toolbar.checkUpdateRetry": "重试更新",
  "toolbar.startupDebugTooltip": "启动调试日志",
  "toolbar.importMarkdownTooltip": "导入 Markdown 或 ZIP",
  ...
  "status.importMarkdownDropOnlyMd": "只能拖入 Markdown（.md）或导出的 ZIP。",
  "status.importZipFailed": "导入 ZIP 失败。",
  "status.importMarkdownDropNeedsVault": "请先打开知识库再导入 Markdown。",
  "status.alwaysOnTopFailed": "切换窗口置顶失败。",
  "status.feedbackOpened": "已在浏览器中打开 GitHub Issues。",
  "status.feedbackFailed": "打开反馈页面失败。",
  "status.updateChecking": "正在检查更新…",
  "status.updateNone": "未找到发布版本。",
  "status.updateCurrent": "已是最新：{channel} {version}。",
  "status.updateFailed": "检查更新失败。",
  "status.updateOpened": "已打开 {version} 的下载页面。",
  "status.updateReleasePageOpened": "已在浏览器中打开发布页面。",
  "status.updateAvailable": "发现新版本：{channel} {version}。",
  "status.updateDownloading": "正在下载 {version}…",
  "status.updateInstallerOpened": "已打开 {version} 安装程序。",
  "status.updateDownloadFailed": "下载安装包失败。",
  "update.channelRelease": "正式版",
  "update.channelPrerelease": "预发布",
  "update.availableTitle": "发现新版本",
  "update.availableMessage": "当前版本 {current}。最新{channel}为 {version}。是否下载并安装？",
  "update.confirm": "更新",
  "update.openDownload": "打开下载页",
  "update.openGitCode": "打开 GitCode",
  "update.openGitHub": "打开 GitHub",
  "update.checkTitle": "检查更新",
  "update.checkCurrent": "当前版本 {version}",
  "update.phaseConnect": "正在连接发布服务",
  "update.phaseFetch": "正在获取 Release 列表",
  "update.phaseCompare": "正在对比版本",
  "update.phaseDownload": "正在下载安装包",
  "update.phaseOpen": "正在打开安装包",
  "update.close": "关闭",
  "update.hide": "隐藏",
  "update.retry": "重试",
  "update.backgroundHint": "按 Esc 可暂时关闭，更新会在后台继续。",
  "update.resultNone": "未找到已发布版本。",
  "update.resultCurrent": "已是最新{channel}：{version}。",
  "update.resultAvailable": "当前版本 {current}。最新{channel}为 {version}。确定后将下载安装包。",
  "update.resultFailed": "无法连接发布服务，请重试或在浏览器中打开 GitCode / GitHub。",
  "update.resultNoInstaller": "该版本没有 Windows 安装包，请改为打开 GitHub 下载页。",
  "update.resultDownloading": "正在下载 {file}…",
  "update.resultOpenedInstaller": "安装程序已打开，请按向导完成更新。",
  "update.resultDownloadFailed": "安装包下载失败，请检查网络后重试。",
  "update.resultTitleCurrent": "已是最新",
  "update.resultTitleNone": "未找到发布",
  "update.resultTitleFailed": "检查更新失败",
  "update.resultTitleDownloading": "正在下载更新",
  "update.resultTitleOpened": "安装程序已打开",
  "update.resultTitleDownloadFailed": "下载失败",
  ...
  "importFiles.title": "正在导入",
  "importFiles.phasePrepare": "读取文件",
  "importFiles.phaseRender": "解压压缩包",
  "importFiles.phaseImages": "复制图片",
  "importFiles.phaseGenerate": "导入笔记",
  "importFiles.phaseSave": "保存笔记",
  "importFiles.phaseDone": "完成",
  "settings.title": "设置",
  ...
  "note.createdAt": "创建时间：{time}",
  "note.updatedAt": "最后更新：{time}",
  "note.times": "文档时间",
  "note.timesAria": "显示或隐藏创建与最后更新时间",
  "note.refresh": "刷新当前文档",
