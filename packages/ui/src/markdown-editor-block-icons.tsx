/** Block menu icons aligned with @milkdown/crepe BlockEdit defaults. */
...
export function CodeBlockIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path
        fill="currentColor"
        d="M9.4 16.6 4.8 12l4.6-4.6L8 6 2 12l6 6 1.4-1.4Zm5.2 0 4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4Z"
      />
    </svg>
  );
}

export function MathBlockIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path fill="currentColor" d="M7 19v-.808L13.096 12 7 5.808V5h10v1.25H9.102L14.727 12l-5.625 5.77H17V19z" />
    </svg>
  );
}

export function TaskListBlockIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path
        fill="currentColor"
