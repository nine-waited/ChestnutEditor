...
| ID | 级别 | 标题 | 自动化 |
|----|------|------|--------|
| DS-001 | P0 | interval dirty 关闭流程依赖 unsaved 标记 | `unsaved-notes` + Skill 手工关 Tab |
| DS-002 | P0 | realtime / 干净刷新前必须 flush | `note-reload` + `VaultService` debounce |
...
| DS-007 | P0 | 分屏同 MD 至多一份可编辑 | `WorkspaceStore` |
